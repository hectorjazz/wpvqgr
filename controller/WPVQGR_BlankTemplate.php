...
class WPVQGR_BlankSlatePageTemplater {
    ...
    public static function get_instance() {
        ...
        if ( null == self::$instance ) {
            self::$instance = new WPVQGR_BlankSlatePageTemplater();
        }
    ...
    private function __construct() {
        ...
        $this->templates = array(
            '../views/WPVQGR_BlankPage.php' => 'Blank Quiz Template',
        );
...
add_action( 'plugins_loaded', array( 'WPVQGR_BlankSlatePageTemplater', 'get_instance' ) );